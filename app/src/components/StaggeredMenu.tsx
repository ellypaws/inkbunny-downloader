...
type StaggeredMenuCSSProperties = React.CSSProperties & {
  "--sm-accent"?: string;
...
export const StaggeredMenu: React.FC<StaggeredMenuProps> = ({
  ...
  const buildOpenTimeline = useCallback(() => {
    ...
    if (numberEls.length)
      gsap.set(numberEls, { "--sm-num-opacity": 0 } satisfies StaggeredMenuCSSProperties);
    ...
    if (itemEls.length) {
      ...
      if (numberEls.length) {
        tl.to(
          ...
          } satisfies gsap.TweenVars & StaggeredMenuCSSProperties,
          itemsStart + 0.1,
        );
      }
    }
  ...
  return (
    ...
    >
      <div
        ...
        style={
          accentColor
            ? ({ "--sm-accent": accentColor } as StaggeredMenuCSSProperties)
            : undefined
        }
